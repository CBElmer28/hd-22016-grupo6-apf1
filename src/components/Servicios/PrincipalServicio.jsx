  ...
  const slides = [
    {
      ...
      description: "Elige Extras Digitales adicionales que se adapten a ti y a tu estilo de vida y disfruta de todo lo que tu Zentauri Quead puede ofrecerte.",
    ...
    {
      title: "Aplicaciones",
      description: "Descubre nuestras aplicaciones diseñadas para mejorar tu experiencia con tu vehículo Zentauri Quead.",
      buttonText: "Más información",
      image: appImg,
      buttonText: "Más información"
    }
    ...
    <div>
      ...
      <section className="hero-section">
        <div className="hero-content">
          <div className="hero-text left-aligned">
            ...
            <p>En Zentauri Quead, nos esforzamos al máximo para ofrecerte servicios de primera clase para tu vehículo y mucho más.</p>
          </div>
        </div>
      ...
      <section className="cards-section">
        <div className="card">
          ...
          <p>Reserva fácilmente citas para mantenimiento, reparaciones y otros servicios en un taller autorizado Zentauri Quead.</p>
        ...
        <div className="card">
          ...
          <p>Mantenimiento, reparación y garantías: todos los servicios para mantener tu Zentauri Quead en perfectas condiciones.</p>
        ...
        <div className="card">
          ...
          <p>Evita preocupaciones con contratos de servicio para mantenimiento y reparaciones de tu Zentauri Quead.</p>
      ...
      <section className="charging-section" style={{ backgroundImage: `url(${chargingBg})` }}>
        ...
        <div className="section-container">
          ...
          <p className="section-description">
            Existe una gran variedad de sencillas opciones para cargar la batería de tu vehículo eléctrico o híbrido enchufable Zentauri Quead.
          </p>
      ...
      <section className="digital-slider-section">
        <div className="slider-container">
          <div className="slider-content">
            ...
            <div className={`slider-image ${transitionDirection}-${isAnimating ? 'exit' : 'enter'}`}>
              <img
          ...
          <div className="slider-controls">
            <button onClick={prevSlide} className="slider-arrow" aria-label="Previous slide">‹</button>
            ...
            <button onClick={nextSlide} className="slider-arrow" aria-label="Next slide">›</button>
          </div>
        </div>
      </section>
